...
const CAPTab = ({ data, projectId }) => {
  ...
  const StatusComponent = ({ value, row }) => {
    console.log("StatusComponent called with:", { value, row }); // Debug log
    ...
    console.log("Final status info:", statusInfo); // Debug log
  ...
  console.log("Transformed CAP data:", transformedData); // Debug log
